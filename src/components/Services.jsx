    ...
    return (
        <section id="services" className=' py-20 w-full h-auto bg-gradient-to-bl from-20% to-80% from-blue-100 to-white'>
            ...
            <div className='hidden md:flex justify-center relative pb-28 '>
                <div className='absolute gap-20 flex flex-col items-center'>
                    <div data-aos="fade-down" className='relative bg-white flex flex-col gap-2 border-4 w-32 h-32 rounded-full border-blue-400'>
                        ...
                        <div data-aos="flip-left" className='absolute -top-2 lg:-left-[30rem] lg:w-[30rem] lg:pr-6 -left-[22rem] w-[20rem] pr-4 space-y-2'>
                            <h3 className='text-xl text-blue-500 font-bold'>Web Development</h3>
                    ...
                    <div data-aos="fade-up" className='relative bg-white flex flex-col gap-2 border-4 w-32 h-32 rounded-full border-blue-400'>
                        ...
                        <div data-aos="flip-right" className='absolute -top-2 lg:-right-[32rem] lg:w-[30rem] -right-[22rem] w-[20rem] lg:pl-4 pl-6 space-y-2'>
                            <h3 className='text-xl text-blue-500 font-bold'>Mobile Development</h3>
            ...
            <div className='block md:hidden relative h-[40rem] px-6 overflow-hidden'>
                <div className='absolute z-10 gap-20 flex flex-col items-center'>
                    <div data-aos="fade-up" className='relative bg-white flex flex-col gap-2 border-4 w-32 h-32 rounded-full border-blue-400'>
                        <FaLaptopCode className='text-4xl text-blue-500 absolute top-10 left-[2.69rem]' data-aos="flip-left" />
                        <div data-aos="flip-right" className='absolute -top-2 -right-[18rem] w-[18rem] px-4 space-y-2'>
                            <h3 className='text-lg text-blue-500 font-bold'>Mobile Development</h3>
                    ...
                    <div data-aos="fade-up" className='relative bg-white flex flex-col gap-2 border-4 w-32 h-32 rounded-full border-blue-400'>
                        <MdOutlineScreenSearchDesktop className='text-4xl text-blue-500 absolute top-10 left-[2.69rem]' data-aos="flip-left" />
                        <div data-aos="flip-right" className='absolute -top-2 -right-[18rem] w-[18rem] px-4 space-y-2'>
                            <h3 className='text-lg text-blue-500 font-bold'>Mobile Development</h3>
                            <p className='text-sm text-gray-500'>La création d'applications mobiles est cruciale pour toucher un large public. Nous développons des applications performantes pour Android et iOS avec React Native, garantissant une expérience optimale.</p>
                        </div>
                ...
                <div className="absolute left-[5.5rem] w-1 h-[30rem] bg-gradient-to-b from-pink-500 via-purple-500 to-blue-500"></div>
            </div>
        </section>
    )
}
